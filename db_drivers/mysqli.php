<?php
	class db_handler implements data_handler{
		...
		public function get($table=NULL,$data=NULL,$offset=NULL,$limit=10,$sort=NULL,$order=NULL)
		{
			$row_count = 0;
			$res = array();
		...
		public function get_where($table=NULL,$data=NULL,$where=NULL,$offset=NULL,$limit=10,$sort=NULL,$sort_order='desc')
		{
